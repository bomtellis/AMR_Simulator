...
class JsonStore:
    ...
    def upsert_lift(
        ...
        payload = {
            ...
            "health_loss_per_journey_percent": round(float(health_loss_per_journey_percent), 3),
            "mean_time_between_failures_hours": round(float(mean_time_between_failures_hours), 3),
